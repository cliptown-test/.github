...
These instructions apply to automation and coding agents working in `cliptown-test` repositories unless a repository defines stricter local policy.

## Durable engineering policy

- This repository defines public organization-wide defaults for `cliptown-test`.
...
- GitHub organization: https://github.com/cliptown-test
- Public organization defaults: https://github.com/cliptown-test/.github
...
3. Review linked pull requests, issues, Linear work, related repositories in `cliptown-test`, and relevant external-organization repositories whenever behavior or contracts cross boundaries.
